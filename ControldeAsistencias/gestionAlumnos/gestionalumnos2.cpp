...
Gestionalumnos2::Gestionalumnos2(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Gestionalumnos2)
{
    ui->setupUi(this);
    Mostrardatos();
}
...
void Gestionalumnos2::Mostrardatos()
{
    QString consulta;
...
void Gestionalumnos2::Eliminaralumno()
{
...
int Gestionalumnos2::Obteneridalumno()
{
...
void Gestionalumnos2::Editaralumno(int id, QString nombre, QString apellido)
{
    QString consulta;
...
void Gestionalumnos2::Obtenercampo(QString &_apellido, QString &_nombres)
{
...
void Gestionalumnos2::on_pushButtonAgregar_clicked()
{
    agregar2 = new Agregar2(this); //Crea un diálogo
    agregar2->showMaximized();
    if(agregar2->exec()){          //se ejecuta después de cerrar la ventana
    } Mostrardatos();
}


void Gestionalumnos2::on_pushButtonEliminar_clicked()
{
        Eliminaralumno();
        Mostrardatos();
}

void Gestionalumnos2::on_pushButtonEditar_clicked()
{
        ...
        editar2 = new Editar2(this);
        editar2->ui->lineEditNombre->setText(""+nombres+"");
        editar2->ui->lineEditApellido->setText(""+apellido+"");
        editar2->ui->plainTextEdit->appendPlainText(""+stringValue+"");
        editar2->IdExiste1();
        editar2->showMaximized();
        if(editar2->exec()){          //se ejecuta después de cerrar la ventana
        } Mostrardatos();
