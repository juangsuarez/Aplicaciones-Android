...
Tomarasistencia2::Tomarasistencia2(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Tomarasistencia2)
{
    ui->setupUi(this);
    contador=0;
...
void Tomarasistencia2::Siguiente()
{
    contador++;
    Recorrertabla();
    if (ui->lineEdit->text()== ", "){
...
void Tomarasistencia2::Recorrertabla()
{
     QString consulta;
     consulta.append("SELECT * FROM alumnos WHERE MateriaID=2");
     QSqlQuery query;
...
void Tomarasistencia2::on_pushButton_2_clicked()
{
...
void Tomarasistencia2::on_pushButton_clicked()
{
