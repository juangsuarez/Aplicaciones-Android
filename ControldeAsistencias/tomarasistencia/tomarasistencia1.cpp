...
Tomarasistencia1::Tomarasistencia1(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Tomarasistencia1)
{
    ui->setupUi(this);
    contador=0;
...
void Tomarasistencia1::Siguiente()
{
    contador++;
    Recorrertabla();
    if (ui->lineEdit->text()== ", "){
...
void Tomarasistencia1::Recorrertabla()
{
     QString consulta;
     consulta.append("SELECT * FROM alumnos WHERE MateriaID=1");
     QSqlQuery query;
...
void Tomarasistencia1::on_pushButton_2_clicked()
{
...
void Tomarasistencia1::on_pushButton_clicked()
{
